...
<?php
  ...
  if ($_POST ["photo"] != "")
  {
    ...
    $ind1 = $_POST ["photo"];
  ?>  
  <form method="post" action="<?php $index = 0; echo ("remove_comment_from_file147.php"); ?>" name="form"
  ...
  <?php $index = 0;
    ...
    if ($i > 0)
    {
      ...
      while ($file = readdir ($hdl))
        ...
        {      	
          $j++;
          if ($_POST ["account"] == substr ($file, 18, strlen ($file) - 18) && ($ind == $j))
          {
      ...
      echo "<p>
      Вы пока не сотавили к данной фотографии ни одного комментария.
      </p>";
  ?>
  </form>
<?php
